...
class TaskPlannerTester:
    ...
    def test_user_registration(self):
        ...
        if response and response.status_code == 400:
            ...
            self.log_test("Duplicate Username Prevention", False, f"Expected 400, got {response.status_code if response else 'no response'}")
    ...
    def test_user_login(self):
        ...
        if response and response.status_code == 401:
            ...
            self.log_test("Invalid Login Prevention", False, f"Expected 401, got {response.status_code if response else 'no response'}")
    ...
    def test_get_current_user(self):
        ...
        if response and response.status_code in [401, 403]:
            ...
            self.log_test("Auth Protection", False, f"Expected 401/403, got {response.status_code if response else 'no response'}")
    ...
    def test_task_creation(self):
        ...
        if response and response.status_code in [401, 403]:
            ...
            self.log_test("Task Creation Auth Protection", False, f"Expected 401/403, got {response.status_code if response else 'no response'}")
    ...
    def test_task_update(self):
        ...
        # Test updating non-existent task (with auth)
        ...
        if response and response.status_code == 404:
            ...
            self.log_test("Non-existent Task Update", False, f"Expected 404, got {response.status_code if response else 'no response'}")
    ...
    def test_task_deletion(self):
        ...
        # Test deleting non-existent task (with auth)
        ...
        if response and response.status_code == 404:
            ...
            self.log_test("Non-existent Task Deletion", False, f"Expected 404, got {response.status_code if response else 'no response'}")
    ...
    def test_authentication_protection(self):
        ...
        for method, endpoint in protected_endpoints:
            ...
            if response and response.status_code in [401, 403]:
                ...
                self.log_test(f"Auth Protection {method} {endpoint}", False, f"Expected 401/403, got {response.status_code if response else 'no response'}")
